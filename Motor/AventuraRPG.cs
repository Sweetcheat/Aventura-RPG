...
namespace Aventura_RPG
{
    ...
    {
        private Jogador _jogador; // privado pois nenhuma outra classe precisa ver o que ocorrerá aqui
        private Monstro _monstroAtual; // privado pois nenhuma outra classe precisa ver o que ocorrerá aqui
        public AventuraRPG()
        {
            InitializeComponent();
        ...
        private void MoverPara(Local novoLocal)
        {
            ...
            if(novoLocal.MonstroVivoAqui != null)
            {
                ...
                // Faz um novo monstro, usando os valores de um monstro 'padrão' que está na lista da CLASSE MUNDO
        ...
        private void buttonUsarArma_Click(object sender, EventArgs e) // EVENTO CLICK DO USO DA ARMA
        {
            ...
            if (_monstroAtual.VidaAtual <= 0)
            {
                ...
                // Se nenhum item foi selecionado randomicamente, então adicionar um item comum (caso seja 0)
                ...
                {
                    _jogador.AdicioneItemAoInventario(inventarioItem.Detalhes); // aqui pode dar erro de lógica, falta instrução em jogador.
